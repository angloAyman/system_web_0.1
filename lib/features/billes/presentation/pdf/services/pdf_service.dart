    ...
    return pw.Table(
      ...
      children: [
        ...
        ...bill.items.map((item) {
          return pw.TableRow(
            children: [
              pw.Text(item.categoryName, textAlign: pw.TextAlign.center),
              pw.Text(item.quantity.toString(), textAlign: pw.TextAlign.center),
              pw.Text('${item.amount}', textAlign: pw.TextAlign.center),
              pw.Text('${item.price_per_unit}', textAlign: pw.TextAlign.center),
            ],
          );
        }).toList(),
      ],
